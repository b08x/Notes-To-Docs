...
import { DocumentTextIcon, ClipboardDocumentCheckIcon, NewspaperIcon, PhotoIcon } from '@heroicons/react/24/outline';
import { BookOpenIcon, CheckBadgeIcon, DocumentCheckIcon } from '@heroicons/react/24/solid';
  ...
  return (
    <>
      ...
      <div className="fixed inset-0 overflow-hidden pointer-events-none z-0">
        ...
        {/* Top Right: Screenshot -> Figure */}
        <div className="hidden lg:block">
            <DrawingTransformation 
            initialIcon={PhotoIcon} 
            finalIcon={DocumentCheckIcon} 
            label="FIGURE"
            delay={6000} 
            x="88%" 
            y="12%"
      ...
      <div className="text-center relative z-10 max-w-6xl mx-auto px-4 pt-8">
        <h1 className="text-4xl sm:text-6xl md:text-7xl lg:text-8xl font-bold tracking-tighter text-white mb-6 leading-[1.1]">
          Turn notes into <br/>
          <span className="underline decoration-4 decoration-blue-500 underline-offset-4 md:underline-offset-8 text-white">Knowledge</span>.
        </h1>
        <p className="text-base sm:text-xl text-zinc-400 max-w-2xl mx-auto leading-relaxed font-light">
          Upload rough notes, screenshots, or messy support tickets. Gemini instantly structures them into professional, clean ServiceNow Knowledge Base articles.
        </p>
      </div>
    </>
  );
